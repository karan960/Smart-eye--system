...
if os.path.isfile("D:/ANPR Dataset/number.xlsx"):
    # Open the existing workbook
    workbook = openpyxl.load_workbook("D:/ANPR Dataset/number.xlsx")
else:
...
while True:
    ...
    for (x, y, w, h) in numberPlates:
        ...
        if area > minArea:
            ...
            if cv2.waitKey(1) & 0xFF == ord('s'):
                ...
                img_path = "D:\ANPR Dataset\Plates\image - {} {} {}.jpg".format(number_plate, date_str, time_str)
    ...
    if key == ord('q'):
        workbook.save("D:/ANPR Dataset/number.xlsx")
        break
